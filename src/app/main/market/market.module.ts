...
import { ShopOrderFinishComponent } from "./shop-order/shop-order-finish/shop-order-finish.component";
...
@NgModule({
  ...
  declarations: [
    ...
    ShopOrderSendedComponent,
    ShopOrderFinishComponent,
    ShopCategoryManageComponent,
    SpecComponent,
  ],
})
